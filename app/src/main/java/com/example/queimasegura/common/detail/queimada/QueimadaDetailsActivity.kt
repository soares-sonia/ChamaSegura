...
class QueimadaDetailsActivity : AppCompatActivity() {
    private lateinit var viewModel: QueimadaDetailsViewModel
    ...
    private fun initViewModels() {
        ...
        val viewModelFactory = QueimadaDetailsViewModelFactory(application, repository)
        viewModel = ViewModelProvider(this, viewModelFactory)[QueimadaDetailsViewModel::class.java]
    }
